...
export const OBSERVATION_DEFINITIONS: Record<ObservationId, ObservationDefinition> = {
  ...
  [OBSERVATION_IDS.BRAKE_PEDAL_SINKS]: {
    id: OBSERVATION_IDS.BRAKE_PEDAL_SINKS,
    label: "Brake pedal slowly sinks when holding steady pressure",
    domain: "BRAKES_HEAT_DRAG",
    notes: [
      DRAFT_NOTE,
      STRONG_SOFT_NOTE,
      "Indicates internal hydraulic bypass (master cylinder) or external leak.",
      "Hold pedal at stop; if it sinks slowly, report YES.",
    ],
    defaultStrength: OBSERVATION_STRENGTH.STRONG,
    isDashLight: false,
    isSafetyCritical: false,
  ...
  [OBSERVATION_IDS.BRAKE_FLUID_LEVEL_LOW]: {
    id: OBSERVATION_IDS.BRAKE_FLUID_LEVEL_LOW,
    label: "Brake fluid level is low (below MIN mark)",
    domain: "BRAKES_HEAT_DRAG",
    notes: [
      DRAFT_NOTE,
      "Low fluid can indicate pad wear OR a leak. Do not assume leak without corroborating evidence.",
      "Medium reliability: user must check reservoir.",
    ],
    defaultStrength: OBSERVATION_STRENGTH.MEDIUM,
    isDashLight: false,
    isSafetyCritical: false,
  ...
  [OBSERVATION_IDS.BRAKE_FLUID_LEVEL_NORMAL]: {
    id: OBSERVATION_IDS.BRAKE_FLUID_LEVEL_NORMAL,
    label: "Brake fluid level is normal (between MIN and MAX)",
    domain: "BRAKES_HEAT_DRAG",
    notes: [
      DRAFT_NOTE,
      "Normal fluid level contradicts leak hypothesis.",
      "Medium reliability: user must check reservoir.",
    ],
    defaultStrength: OBSERVATION_STRENGTH.MEDIUM,
    isDashLight: false,
  ...
  [OBSERVATION_IDS.RECENT_BRAKE_SERVICE]: {
    id: OBSERVATION_IDS.RECENT_BRAKE_SERVICE,
    label: "Brake work done recently (pads, rotors, caliper, or bleeding)",
    domain: "BRAKES_HEAT_DRAG",
    notes: [
      DRAFT_NOTE,
      "Recent service + spongy pedal may indicate air in lines / improper bleed.",
      "Medium reliability.",
    ],
    defaultStrength: OBSERVATION_STRENGTH.MEDIUM,
    isDashLight: false,
  ...
  [OBSERVATION_IDS.VISIBLE_FLUID_UNDER_CAR]: {
    id: OBSERVATION_IDS.VISIBLE_FLUID_UNDER_CAR,
    label: "Fresh fluid spots visible where car normally parks",
    domain: "BRAKES_HEAT_DRAG",
    notes: [
      DRAFT_NOTE,
      STRONG_SOFT_NOTE,
      "Strong indicator of a leak (brake fluid or other).",
      "Color: brake fluid is typically clear/amber. Check location.",
    ],
    defaultStrength: OBSERVATION_STRENGTH.STRONG,
    isDashLight: false,
    isSafetyCritical: false,
  ...
  [OBSERVATION_IDS.VISIBLE_FLUID_NEAR_WHEEL]: {
    id: OBSERVATION_IDS.VISIBLE_FLUID_NEAR_WHEEL,
    label: "Wetness or fluid visible near a wheel or caliper area",
    domain: "BRAKES_HEAT_DRAG",
    notes: [
      DRAFT_NOTE,
      STRONG_SOFT_NOTE,
      "Strong indicator of brake fluid leak at caliper, hose, or line.",
      "Localizes leak to specific wheel.",
    ],
    defaultStrength: OBSERVATION_STRENGTH.STRONG,
    isDashLight: false,
    isSafetyCritical: false,
